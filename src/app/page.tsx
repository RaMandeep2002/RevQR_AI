      ...
      <main className="flex-1 pt-40 pb-24 relative z-10">
        ...
        <section className="relative mx-auto max-w-7xl px-6 text-center lg:px-8">
          ...
          <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-zinc-400 sm:text-xl">
            ...
            systems to collect reviews, automate smart replies, and analyze
            customer sentiment in real-time.
          </p>
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-5">
            <Link
              href="/auth"
              className="group relative w-full sm:w-auto rounded-full bg-gradient-to-r from-emerald-500 to-teal-400 p-[1px] hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all duration-300 hover:-translate-y-1 active:translate-y-0"
            >
            ...
            <Link
              href="/dashboard"
              className="w-full sm:w-auto rounded-full border border-white/10 bg-white/5 hover:bg-white/10 px-8 py-4 text-lg font-bold text-zinc-300 hover:text-white backdrop-blur-md transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl group"
            >
              View Demo Dashboard{" "}
              <span
                aria-hidden="true"
          ...
          <div
            id="how-it-works"
            className="mt-24 rounded-[2.5rem] border border-white/10 bg-zinc-950/40 p-2 shadow-2xl backdrop-blur-xl lg:mt-32 overflow-hidden relative group"
          >
            ...
            <div className="rounded-[2rem] border border-white/5 bg-zinc-950/80 p-8 sm:p-12 shadow-inner relative z-10">
              <h2 className="text-center text-3xl font-extrabold text-white mb-12 tracking-tight">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                {[
                  ...
                  },
                  {
                    icon: Star,
                    title: "AI Reputation",
                    desc: "Our Gemini AI helps users craft detailed reviews while you manage everything from a smart dashboard.",
                  },
                ].map((feature, i) => (
                  <div
                    key={i}
                    className="group/card relative p-8 rounded-3xl bg-white/5 border border-white/5 hover:border-emerald-500/30 hover:bg-white/[0.07] transition-all duration-500 overflow-hidden"
                  >
        ...
        <section id="features" className="py-32 relative">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-sm font-bold leading-7 text-emerald-400 uppercase tracking-[0.2em]">
                AI-Driven Insights
              </h2>
        ...
        {/* <section id="send" className="py-24 sm:py-32">
      ...
      <footer className="bg-zinc-950 border-t border-white/5 py-12 px-6 mt-12 relative z-10">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-sm font-semibold text-zinc-500">
            <a href="/privacy-polices" className="hover:text-emerald-400 transition-colors">
              Privacy Policy
            </a>
